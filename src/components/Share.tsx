  ...
  return (
    <div className="p-4 flex gap-4">
      ...
      <div className="flex flex-col gap-4 flex-1">
        ...
        {/* PREVIEW IMAGE */}
        {previewURL&& <div className="relative ronded-xl overflow-hidden object-cover">
        ...
        <div className="flex items-center justify-between flex-wrap">
          <div className="flex gap-4 items-center text-iconBlue">
            <input onChange={handleMediaChange} className="hidden"  accept="image/png,image/jpg" type="file" id="file" />
            <label htmlFor="file">
